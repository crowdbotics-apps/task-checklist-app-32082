...
## Project Structure
    ...
    ├── task_checklist_app_32082  # Django project configurations
...
1. Clone this repo and `cd task_checklist_app_32082`
...
2. Clone this repo and `cd task_checklist_app_32082`
